          ...
          <div className="caption">
            ...
            <div className="row">
              <div className="col-xs-12 col-md-6">
                <p className="lead">
                  {series.genre}/ {stateuses[series.status]}
                </p>
              </div>
              <div className="col-xs-12 col-md-6">
                ...
                <a className="btn btn-success" onClick={() => this.deleteSeries(series.id)}>
                  Excluir
                </a>
              </div>
            </div>
    ...
    return (
      <section id="intro" className="intro-section">
        ...
        {!this.state.isLoading && this.state.series.length === 0 && (
          <div className="alert alert-info">Ahhh que pena! Nenhuma série cadastrada :(</div>
        )}
